  ...
  return (
    <div className="remove-scrollbar min-h-screen bg-background">
      ...
      <section className="relative bg-black text-white overflow-hidden min-h-[500px]">
        ...
        <div className="margin-acca container mx-auto  relative z-10">
          <div className="">
            ...
            >
              ACCA Virtual<br></br> Skills Platform
              <span style={{ color: "#D20024" }}>.</span>
            </h1>
            <p
              className=""
              style={{
      ...
      <section className="width">
        <div className="container mx-auto px-4 py-6  text-left">
          ...
          <p className="">
            ...
            and innovation. Strengthen your interview performance with our
            Interview Prep Video Series, featuring expert guidance and practical
            assignments.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 max-w-8xl mx-auto gap-class">
            ...
            <div className=" overflow-hidden">
              ...
              <div className="pt-2">
                ...
                <p className="mb-4">
                  Prepare for real-world interviews with expert guidance, and
                  practical tips:
                </p>
                ...
                <span className="inline-flex items-center justify-center align-baseline">
                  ...
                  <span
                    className="inline-flex items-center justify-center ml-2 mt-1"
              ...
              <div className="pt-2">
                ...
                <ul className="space-y-2 mb-4 only-ul pl-4">
                  ...
                  <li className="flex items-start">
                    <span className="w-1.5 h-1.5 bg-[#1e1e1e] rounded-full mt-3 mr-4 flex-shrink-0 bullets"></span>
                    <span className="">
                      Tailored to strengthen your understanding
                    </span>
                  </li>
                </ul>
                ...
                <span className="inline-flex items-center justify-center align-baseline">
                  ...
                  <span
                    className="inline-flex items-center justify-center align-baseline ml-2 mt-1"
                    style={{ color: "rgb(200, 0, 0)" }}
                  >
                    <svg
                      width="16"
      ...
      <section className="py-0 bg-gradient-to-r from-[#C80000] to-[#E50068] key-skills-section">
        <div className="container mx-auto px-4">
          <h2 className="text-left mb-4 h2-fonts skills-gain">
          ...
          <div className="text-center mt-2">
            <p className=" max-w-4xl mx-auto this-para">
              Together, these skills build your confidence in environmental
              awareness, technological fluency, and career readiness.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-black py-12 careers">
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          >
            <span
              className="px-4 py-2 text-[20px] flex-grow"
              style={{ color: "#fff" }}
            >
              Find your next role
            </span>
